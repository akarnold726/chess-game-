...
{
    int r = x + 1;
    //four loops are to check if king is being attacked from all four directions
    while (r < 8)
    {
    ...
    // four loops to check if it is being attacked from diagnols 
    int a = x + 1, b = y + 1;
    while (a < 8 && b < 8)
    {
    ...
    //loop to check if the king is being attacked by knight of opposite color 
